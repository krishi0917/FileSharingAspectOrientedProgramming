...
@param filePath location of the file to be shared. / void shareFile(String userId, String targetUserID, String filePath); /
...
@param filePath location of the file to be shared. / void unshareFile(String userId, String targetUserID, String filePath); /
